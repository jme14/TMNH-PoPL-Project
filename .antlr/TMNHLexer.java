...
public class TMNHLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "WHILE", "FOR", "IN", "IF", "ELSE", "ELIF", "AND", "OR", 
			"NOT", "DIVIDE", "MULTIPLY", "MOD", "PLUS", "MINUS", "RANGE", "NUMBER", 
			"TEXT_SEQUENCE", "TAB", "ESCAPE", "NEWLINE", "WHITESPACE", "COLON", "COMMA", 
			"LEFT_PARENTHESIS", "RIGHT_PARENTHESIS", "LEFT_SQ_BRACKET", "RIGHT_SQ_BRACKET", 
