...
public class TMNHParser extends Parser {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "statement", "arithmetic", "expr", "array", "list", "math_op", 
			"assign_op", "conditional_op"
		};
	}
	...
	public final Math_opContext math_op() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_math_op);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Conditional_opContext conditional_op() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_conditional_op);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
